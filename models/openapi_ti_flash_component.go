...
func (m *OpenapiTiFlashComponent) validateNodeQuantity(formats strfmt.Registry) error {
...
func (m *OpenapiTiFlashComponent) validateNodeSize(formats strfmt.Registry) error {
...
func (m *OpenapiTiFlashComponent) validateStorageSizeGib(formats strfmt.Registry) error {
...
func (m *OpenapiTiFlashComponent) UnmarshalBinary(b []byte) error {
	var res OpenapiTiFlashComponent
