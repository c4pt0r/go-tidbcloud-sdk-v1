...
// NewCreatePrivateEndpointServiceParams creates a new CreatePrivateEndpointServiceParams object,
...
func NewCreatePrivateEndpointServiceParams() *CreatePrivateEndpointServiceParams {
	return &CreatePrivateEndpointServiceParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewCreatePrivateEndpointServiceParamsWithTimeout creates a new CreatePrivateEndpointServiceParams object
...
// NewCreatePrivateEndpointServiceParamsWithContext creates a new CreatePrivateEndpointServiceParams object
...
// NewCreatePrivateEndpointServiceParamsWithHTTPClient creates a new CreatePrivateEndpointServiceParams object
...
func (o *CreatePrivateEndpointServiceParams) WithDefaults() *CreatePrivateEndpointServiceParams {
	o.SetDefaults()
	return o
}
...
func (o *CreatePrivateEndpointServiceParams) WithTimeout(timeout time.Duration) *CreatePrivateEndpointServiceParams {
...
func (o *CreatePrivateEndpointServiceParams) WithContext(ctx context.Context) *CreatePrivateEndpointServiceParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the create private endpoint service params
func (o *CreatePrivateEndpointServiceParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the create private endpoint service params
func (o *CreatePrivateEndpointServiceParams) WithHTTPClient(client *http.Client) *CreatePrivateEndpointServiceParams {
...
func (o *CreatePrivateEndpointServiceParams) WithBody(body interface{}) *CreatePrivateEndpointServiceParams {
	o.SetBody(body)
	return o
}
...
func (o *CreatePrivateEndpointServiceParams) WithClusterID(clusterID string) *CreatePrivateEndpointServiceParams {
...
func (o *CreatePrivateEndpointServiceParams) WithProjectID(projectID string) *CreatePrivateEndpointServiceParams {
...
func (o *CreatePrivateEndpointServiceParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
